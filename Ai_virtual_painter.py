...
brushThickness = 25
eraserThickness = 100
drawColor=(0,0,0)#setting purple color
...
header1=overlayList[0]#storing 1st image 
...
while True:
    ...
    if len(lmList)!=0:
        ...
        if fingers[1] and fingers[2]:
            ...
            #checking for click
            if y1 < 125:
                if 343 < x1 < 693:#if i m clicking at purple brush
                    header1 = overlayList[0]
                    time.sleep(10)
                    webbrowser.open("www.Aissmsioit.com")
                    #drawColor = (255, 0, 255)
                elif 695 < x1 < 863:#if i m clicking at blue brush
                    header1 = overlayList[1]
                    time.sleep(10)
                    webbrowser.open("www.itsa.com")
                    #drawColor = (255, 0, 0)
                elif 865 < x1 < 1080:#if i m clicking at green brush
                    header1 = overlayList[2]
                    time.sleep(10)
                    webbrowser.open("www.insta/itsa.com")
                    #drawColor = (0, 255, 0)
                elif 1082 < x1 < 1280:#if i m clicking at eraser
                    header1 = overlayList[3]
                    time.sleep(10)
                    webbrowser.open("www.acm.com")
                    #drawColor = (0, 0, 0)
    ...
    img[0:125,0:1280]=header1# on our frame we are setting our JPG image acc to H,W of jpg images
